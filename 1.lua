...
local KEYS = {
   ...
   -- ["4910781278127791027"] = { year = 2025, month = 10, day = 25 },  -- Toji
...
------------------------------------------------------
   do
    ...
    local MenuWindow = MachoMenuTabbedWindow("Fisher", MenuStartCoords.x, MenuStartCoords.y, MenuSize.x, MenuSize.y, TabsBarWidth)
