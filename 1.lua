...
local KEYS = {
    ...
    ["4912351135467962038"] = { year = 2025, month = 11, day = 19 },  -- jimmy
    ["4918287178106807021"] = { year = 2025, month = 10, day = 11 }-- pikachu
}
...
CreateThread(function()
    ...
    while GetResourceState("lb-phone") ~= "started" and GetResourceState("wasabi_bridge") ~= "started" and waitTime < timeout do
        Wait(500)
        waitTime = waitTime + 500
    end

    if GetResourceState("lb-phone") == "started" or GetResourceState("wasabi_bridge") == "started" then
        -- Success notification
        MachoMenuNotification("#bypass 2", "loaded")

        -- Inject commands into whichever resource is available
        MachoInjectResource((CheckResource("lb-phone") and "lb-phone") or (CheckResource("wasabi_bridge") and "wasabi_bridge"),
[[
